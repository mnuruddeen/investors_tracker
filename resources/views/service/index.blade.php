                  ...
                  <tbody>
                    ...
                    @if(count($services) > 0)
                      ...
                      <tr>
                        ...
                        <td>
                          @if($service->image)
                            <img src="{{ asset('main/img/services/'.$service->image) }}" class="" height="70" width="70">
                          @endif
                        </td>
                        <td>{{ $service->name }}</td>
                        <td>{{ $service->description }}</td>
                        <td>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#edit_modal{{ $service->id }}">
                            <span class="tf-icons bx bx-pencil"></span>
                          </a>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#delete_modal{{ $service->id }}">
                            <span class="tf-icons bx bx-trash"></span>
                          </a>

                          <!-- Edit modal -->
                          <div class="modal fade" id="edit_modal{{ $service->id }}" tabindex="-1" aria-hidden="true">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="row">
                                      <div class="col mb-3">
                                        ...
                                        <textarea name="description" class="form-control" placeholder="Service Description" rows="4" required>{{ $service->description }}</textarea>
                                      </div>
                                    </div>                                    
                                  </div>
                          ...
                          <!-- //Edit modal -->
                          <!-- Delete -->
                          <div class="modal fade" id="delete_modal{{ $service->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="text-center pt-2 pb-4">
                                  ...
                                  <div>
                                    ...
                                    <a href="{{ url('services/'.encrypt($service->id).'/delete') }}" class="btn rounded-pill btn-primary">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>
