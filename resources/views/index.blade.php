          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 py-3 wow fadeInRight">
              <div class="img-fluid py-3 text-center">
                <img src="{{ asset('main/img/banner_image_2.svg') }}" alt="">
              </div>
            </div>
          </div>
        </div> <!-- .container -->
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4">
              <div class="card-service wow fadeInUp">
                <div class="header">
                  <img src="{{ asset('main/img/services/service-1.svg') }}" alt="">
                </div>
                <div class="body">
            ...
            <div class="col-md-4 col-sm-4">
              <div class="card-service wow fadeInUp">
                <div class="header">
                  <img src="{{ asset('main/img/services/service-2.svg') }}" alt="">
                </div>
                <div class="body">
            ...
            <div class="col-md-4 col-sm-4">
              <div class="card-service wow fadeInUp">
                <div class="header">
                  <img src="{{ asset('main/img/services/service-3.svg') }}" alt="">
                </div>
                <div class="body">
