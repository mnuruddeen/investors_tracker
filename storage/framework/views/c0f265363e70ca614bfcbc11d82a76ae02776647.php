...
<head>
    ...
    <title><?php echo e(config('app.name', 'BS-PCAC')); ?></title>
        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            <a href="<?php echo e(url('/')); ?>" class="app-brand-link gap-2">
              <img src="<?php echo e(url('assets/img/logo.png')); ?>" height="70" width="70">
            </a>
          </div>
          <!-- /Logo -->
...
<?php /**PATH C:\Users\Administrator\Desktop\Repository\grv-mis\resources\views/auth/login.blade.php ENDPATH**/ ?>