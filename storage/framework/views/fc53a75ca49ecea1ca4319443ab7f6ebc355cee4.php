            ...
            <table width="100%" border="0" cellpadding="5" class="table-striped table-bordered mb-5 small">
                ...
                <?php if(count($employees) > 0): ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo e(strtoupper($employee->gender)); ?></td>
                    <td><?php echo e(strtoupper($employee->cadre->cadre)); ?></td>
                    <td><?php echo e(strtoupper($employee->rank->rank)); ?></td>
                    <td><?php echo e(strtoupper($employee->rank->grade_level)); ?></td>
                    <td><?php echo e(strtoupper($employee->step)); ?></td>
                  </tr>
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Repository\bs-pcac\resources\views/report/employee.blade.php ENDPATH**/ ?>