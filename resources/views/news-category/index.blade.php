                  ...
                  <tbody>
                    ...
                    @if(count($categories) > 0)
                      ...
                      <tr>
                        ...
                        <td>{{ $category->name }}</td>
                        <td>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#edit_modal{{ $category->id }}">
                            <span class="tf-icons bx bx-pencil"></span>
                          </a>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#delete_modal{{ $category->id }}">
                            <span class="tf-icons bx bx-trash"></span>
                          </a>
                          <!-- Edit modal -->
                          <div class="modal fade" id="edit_modal{{ $category->id }}" tabindex="-1" aria-hidden="true">
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                      <div class="col mb-3">
                                        ...
                                        <input type="text" name="category" value="{{ $category->name }}" class="form-control" required/>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <!-- //Edit modal -->
                          <!-- Delete -->
                          <div class="modal fade" id="delete_modal{{ $category->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="text-center pt-2 pb-4">
                                  ...
                                  <div>
                                    ...
                                    <a href="{{ url('categories/'.encrypt($category->id).'/delete') }}" class="btn rounded-pill btn-primary">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>
