...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('main/css/maicons.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('main/css/bootstrap.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('main/vendor/animate/animate.css')); ?>">
...
<body>
  ...
  <div class="back-to-top"></div>
    ...
    <script src="<?php echo e(asset('main/js/jquery-3.5.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('main/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('main/js/google-maps.js')); ?>"></script>
    <script src="<?php echo e(asset('main/vendor/wow/wow.min.js')); ?>"></script>
...
<?php /**PATH C:\Users\Administrator\Desktop\Repository\CofOs\resources\views/layouts/main.blade.php ENDPATH**/ ?>