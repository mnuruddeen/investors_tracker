                  ...
                  <tbody>
                    ...
                    @if(count($partners) > 0)
                      ...
                      <tr>
                        ...
                        <td>
                          @if($partner->logo)
                          <img src="{{ asset('main/img/partners/'.$partner->logo) }}" class="" height="50" width="50">
                          @endif
                        </td>
                        <td>{{ $partner->name }}</td>
                        <td>{{ strtoupper($partner->abr) }}</td>
                        <td>{{ strtolower($partner->website) }}</td>
                        <td>
                          @if($partner->status)
                        ...
                        <td>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#edit_modal{{ $partner->id }}">
                            <span class="tf-icons bx bx-pencil"></span>
                          </a>
                          <a href="button" class="btn btn-xs p-3 rounded-pill btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#delete_modal{{ $partner->id }}">
                            <span class="tf-icons bx bx-trash"></span>
                          </a>
                          <!-- Edit modal -->
                          <div class="modal fade" id="edit_modal{{ $partner->id }}" tabindex="-1" aria-hidden="true">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="row">
                                      <div class="col mb-3">
                                        ...
                                        <input type="text" name="abbreviation" value="{{ $partner->abr }}" class="form-control" required/>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col mb-3">
                          ...
                          <!-- //Edit modal -->
                          <!-- Delete -->
                          <div class="modal fade" id="delete_modal{{ $partner->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="text-center pt-2 pb-4">
                                  ...
                                  <div>
                                    ...
                                    <a href="{{ url('partners/'.encrypt($partner->id).'/delete') }}" class="btn rounded-pill btn-primary">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>
